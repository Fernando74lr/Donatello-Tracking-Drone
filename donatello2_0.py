...
pidForZaxis = PID(0.8, 0.0001, 0.0001, setpoint=h//2)    # Pid object for Z axis
pidForZaxis.output_limits = (-100, 100)      # updownSpeed limits

pidForXaxis = PID(0.001, 0.00001, 0.0001, setpoint=(fbRange[1] + fbRange[0])//2)    # Pid object for X axis
...
if __name__ == "__main__":
    ...
    # while cap:
        ...
        # Keyboard Control
        lr, fb, ud, yv, optionMenu = keyControl.getKeyboardInput(donatello, optionMenu, frame)
        if(optionMenu == 0):
                ...
                if detection is not None:
                    ...
                    for x1, y1, x2, y2, conf, cls_conf, cls_pred in detection:
                        ...
                        if cls_pred == 0:
                            ...
                            cv2.rectangle(frame, (x1, y1 + box_h), (x2, y1), color, 3)
                            ...
                            if booleanExpresion:
                                ...
                                cv2.circle(frame, (c[0], c[1]), 15, (0, 0, 255), cv2.FILLED)
